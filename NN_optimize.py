...
def NN(neur2 = 128, neur1 = 128, neur3 = 64, drop_rate = 0.01, lr = 0.008,
...
def Optimize(preset):
    ...
    learn_rate = [0.006, 0.008, 0.009, 0.01, 0.012]
    dropout_rate = [0.01, 0.02, 0.03, 0.05, 0.07]
    neurons1 = [32, 64, 128]
    neurons2 = [64, 128, 256]
    ...
    cv_model = KerasRegressor(build_fn = NN, epochs = 100, verbose = 0)
    param_grid = dict(neur1 = neurons1, neur2 = neurons2, neur3 = neurons3, drop_rate = dropout_rate,
